...
sudo ssh $clt1 "/home/jorocgon/perftestRepo/compile/ib_write_bw -d mlx5_1 $srv1 -n $1 >       /home/jorocgon/paper2CC/ThirdScenario_a_$rtng\_$2.txt" &
#sleep 5
sudo ssh $clt2 "/home/jorocgon/perftestRepo/compile/ib_write_bw -d mlx5_1 $srv1 -n $1 -p 21 > /home/jorocgon/paper2CC/ThirdScenario_b_$rtng\_$2.txt" &
...
cp /var/tmp/ibdiagnet2/ibdiagnet2.rnc ./ThirdScenario_RN_$rtng\_$2.txt
cp /var/tmp/ibdiagnet2/ibdiagnet2.db_csv ./ThirdScenario_CCN_$rtng\_$2.txt
...
echo "scale=10; $val1/164840000000" | bc >  DataThirdScenario$rtng\_$2.txt
echo "scale=10; $val2/164840000000" | bc >> DataThirdScenario$rtng\_$2.txt
echo "scale=10; $val3/164840000000" | bc >> DataThirdScenario$rtng\_$2.txt
echo "scale=10; $val4/164840000000" | bc >> DataThirdScenario$rtng\_$2.txt
echo "scale=10; $val5/164840000000" | bc >> DataThirdScenario$rtng\_$2.txt
echo "scale=10; $val6/164840000000" | bc >> DataThirdScenario$rtng\_$2.txt
echo "scale=10; $val7/164840000000" | bc >> DataThirdScenario$rtng\_$2.txt
echo "scale=10; $val8/164840000000" | bc >> DataThirdScenario$rtng\_$2.txt
echo "scale=10; $val9/164840000000" | bc >> DataThirdScenario$rtng\_$2.txt


echo "scale=10; $val1P/160000000" | bc >  PktsThirdScenario$rtng\_$2.txt
echo "scale=10; $val2P/160000000" | bc >> PktsThirdScenario$rtng\_$2.txt
echo "scale=10; $val3P/160000000" | bc >> PktsThirdScenario$rtng\_$2.txt
echo "scale=10; $val4P/160000000" | bc >> PktsThirdScenario$rtng\_$2.txt
echo "scale=10; $val5P/160000000" | bc >> PktsThirdScenario$rtng\_$2.txt
echo "scale=10; $val6P/160000000" | bc >> PktsThirdScenario$rtng\_$2.txt
echo "scale=10; $val7P/160000000" | bc >> PktsThirdScenario$rtng\_$2.txt
echo "scale=10; $val8P/160000000" | bc >> PktsThirdScenario$rtng\_$2.txt
echo "scale=10; $val9P/160000000" | bc >> PktsThirdScenario$rtng\_$2.txt


awk 'NR > 19 { print }' < ThirdScenario_a_$rtng\_$2.txt  > temp.txt
head -n -2 temp.txt > ThirdScenario_a_$rtng\_$2.txt

awk 'NR > 19 { print }' < ThirdScenario_b_$rtng\_$2.txt  > temp.txt
head -n -2 temp.txt > ThirdScenario_b_$rtng\_$2.txt



echo "All done!"
tail  /home/jorocgon/paper2CC/ThirdScenario_a_$rtng\_$2.txt
echo "hohoho"
tail  /home/jorocgon/paper2CC/ThirdScenario_b_$rtng\_$2.txt
