...
sudo ssh $clt1 "/home/jorocgon/perftest-master/ib_write_bw -F -d mlx5_1 $srv1 -n $1 $rate --perform_warm_up  >  /home/jorocgon/paper2CC/NewScenario_a_$rtng\_$2.txt" &
sudo ssh $clt2 "/home/jorocgon/perftest-master/ib_write_bw -F -d mlx5_1 $srv1 -n $1 $rate -p 21 --perform_warm_up > /home/jorocgon/paper2CC/NewScenario_b_$rtng\_$2.txt" &
sudo ssh $clt3 "/home/jorocgon/perftest-master/ib_write_bw -F -d mlx5_1 $srv2 -n $1 $rate --perform_warm_up > /home/jorocgon/paper2CC/NewScenario_c_$rtng\_$2.txt" &
...
cp /var/tmp/ibdiagnet2/ibdiagnet2.rnc ./NewScenario_RN_$rtng\_$2.txt
cp /var/tmp/ibdiagnet2/ibdiagnet2.db_csv ./NewScenario_CCN_$rtng\_$2.txt
...
echo "scale=10; $val1/164840000000" | bc >  DataNewScenario$rtng\_$2.txt
echo "scale=10; $val2/164840000000" | bc >> DataNewScenario$rtng\_$2.txt
echo "scale=10; $val3/164840000000" | bc >> DataNewScenario$rtng\_$2.txt
echo "scale=10; $val4/164840000000" | bc >> DataNewScenario$rtng\_$2.txt
printf "------\n"
echo "scale=10; $val5/164840000000" | bc >>  DataNewScenario$rtng\_$2.txt
echo "scale=10; $val6/164840000000" | bc >> DataNewScenario$rtng\_$2.txt
echo "scale=10; $val7/164840000000" | bc >> DataNewScenario$rtng\_$2.txt
echo "scale=10; $val8/164840000000" | bc >> DataNewScenario$rtng\_$2.txt

echo "scale=10; $val1P/160000000" | bc >  PktsNewScenario$rtng\_$2.txt
echo "scale=10; $val2P/160000000" | bc >> PktsNewScenario$rtng\_$2.txt
echo "scale=10; $val3P/160000000" | bc >> PktsNewScenario$rtng\_$2.txt
echo "scale=10; $val4P/160000000" | bc >> PktsNewScenario$rtng\_$2.txt
printf "------\n"
echo "scale=10; $val5P/160000000" | bc >>  PktsNewScenario$rtng\_$2.txt
echo "scale=10; $val6P/160000000" | bc >> PktsNewScenario$rtng\_$2.txt
echo "scale=10; $val7P/160000000" | bc >> PktsNewScenario$rtng\_$2.txt
echo "scale=10; $val8P/160000000" | bc >> PktsNewScenario$rtng\_$2.txt


awk 'NR > 19 { print }' < NewScenario_a_$rtng\_$2.txt  > temp.txt
head -n -2 temp.txt > NewScenario_a_$rtng\_$2.txt

awk 'NR > 19 { print }' < NewScenario_b_$rtng\_$2.txt  > temp.txt
head -n -2 temp.txt > NewScenario_b_$rtng\_$2.txt

awk 'NR > 19 { print }' < NewScenario_c_$rtng\_$2.txt  > temp.txt
head -n -2 temp.txt > NewScenario_c_$rtng\_$2.txt
